...
export function FolioMark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 512 512" className={className} role="presentation" aria-hidden="true">
      ...
      <line x1="109" y1="256" x2="403" y2="256" stroke="#1B365D" strokeOpacity="0.353" strokeWidth="6" strokeLinecap="round" />
      <line x1="256" y1="109" x2="256" y2="403" stroke="#1B365D" strokeOpacity="0.353" strokeWidth="6" strokeLinecap="round" />
