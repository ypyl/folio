...
describe('FolderRail', () => {
  it('renders no entries while restoring', () => {
    render(
      <FolderRail status="restoring" folders={[]} activeId={null} onAdd={vi.fn()} onActivate={vi.fn()} />,
    )
  ...
  it('renders the add button and one avatar per folder', () => {
    ...
    render(
      <FolderRail status="ready" folders={folders} activeId="b" onAdd={vi.fn()} onActivate={vi.fn()} />,
    )
  ...
  it('marks the active folder and fires activate on click', () => {
    ...
    render(
      <FolderRail status="ready" folders={folders} activeId="a" onAdd={vi.fn()} onActivate={onActivate} />,
    )
  ...
  it('renders pending folders with the pending marker', () => {
    ...
    render(
      <FolderRail status="ready" folders={folders} activeId={null} onAdd={vi.fn()} onActivate={vi.fn()} />,
    )
  ...
  it('fires add on the + button', () => {
    const onAdd = vi.fn()
    render(<FolderRail status="ready" folders={[]} activeId={null} onAdd={onAdd} onActivate={vi.fn()} />)
